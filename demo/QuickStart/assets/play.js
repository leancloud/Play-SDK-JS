(function(global, factory) {
  ...
  class Player {
    ...
    isMaster() {
      return (
        this._actorId !== -1 && this._play._room.masterId === this._actorId
      );
    }
  ...
  const debug$1 = require('debug')('Handler');
  ...
  const debug$2 = require('debug')('Play');
  ...
  class Play extends eventemitter3 {
    ...
    _connectToMaster() {
      ...
      this._websocket.onclose = () => {
        debug$2('Lobby websocket closed');
